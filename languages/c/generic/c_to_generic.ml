...
and expr e =
  ...
  | Postfix (v1, (v2, v3)) ->
      ...
      G.special (G.IncrDecr (v2, G.Postfix), v3) [ v1 ]
  | Infix (v1, (v2, v3)) ->
      let v1 = expr v1 and v2 = fixOp v2 in
      G.special (G.IncrDecr (v2, G.Prefix), v3) [ v1 ]
  | Unary (v1, v2) ->
...
and special_wrap (spec, tk) =
  match spec with
  | SizeOf -> G.Special (G.Sizeof, tk) |> G.e
